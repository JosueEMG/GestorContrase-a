...
public class dialogLogin extends javax.swing.JDialog {
    ...
    public dialogLogin(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtNom)
                            .addComponent(txtContra, javax.swing.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE))
                        .addGap(36, 36, 36))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        for(Usuarios u: obj.getUsuarios()){
            if(nombre.equals(u.getNombre())&&contraseña.equals(u.getContraseña())){
                ...
                dialogListCuentas.nombre=u.getNombre();
                dialogListCuentas fr=new dialogListCuentas(this, rootPaneCheckingEnabled);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogLogin dialog = new dialogLogin(new javax.swing.JDialog(), true);
